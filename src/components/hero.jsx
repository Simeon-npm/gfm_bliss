...
const hero = () => {
  return (
    <div className=' hero w-full h-[90vh] flex flex-col items-center justify-center text-white'>
        <div className='flex flex-col items-center w-[70%] sm:w-[100%] text-center gap-6'>
            ...
            <p className='text-neutral-300 text-lg sm:text-xs w-[70%] sm:w-[85%]'>Licensed electricians available for installations, repairs, and emergency services. Serving your community with over 20 years of experience</p>
